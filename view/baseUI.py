...
class BaseUI(object):
    def setupUi(self, Form,id):
        ...
        self.input_1.returnPressed.connect(lambda: self.updateALL(1,self.input_1.text()))
        self.input_2.returnPressed.connect(lambda: self.updateALL(2, self.input_2.text()))
        self.input_3.returnPressed.connect(lambda: self.updateALL(3, self.input_3.text()))
        self.input_4.returnPressed.connect(lambda: self.updateALL(4, self.input_4.text()))
    ...
    def retranslateUi(self, Form):
        ...
        self.ID.setText(_translate("Form", Form.baseUI.data.id))
        self.label_3.setText(_translate("Form", "机组型式"))
        self.name.setText(_translate("Form", Form.baseUI.data.name))
        self.label_5.setText(_translate("Form", "装机总量"))
        self.capacity.setText(_translate("Form", '%d'%Form.baseUI.data.capacity))
        self.groupBox_3.setTitle(_translate("Form", "参数"))
        self.consume_coal_1.setText(_translate("Form", "0"))
        self.label_22.setText(_translate("Form", "煤耗"))
        self.consume_1.setText(_translate("Form", '%d'%Form.baseUI.data.consume_1))
        ...
        self.label_21.setText(_translate("Form", "运行时长"))
        self.consume_2.setText(_translate("Form", '%d'%Form.baseUI.data.consume_2))
        self.load_1.setText(_translate("Form", "1"))
        self.label_23.setText(_translate("Form", "负荷"))
        self.load_3.setText(_translate("Form", "0.5"))
        self.consume_4.setText(_translate("Form", '%d'%Form.baseUI.data.consume_4))
        ...
        self.power_self_1.setText(_translate("Form", "0"))
        ...
        self.power_self_3.setText(_translate("Form", "0"))
        self.power_self_2.setText(_translate("Form", "0"))
        self.consume_3.setText(_translate("Form", '%d'%Form.baseUI.data.consume_3))
        ...
        self.power_self_4.setText(_translate("Form", "0"))
        ...
        self.consume_coal_2.setText(_translate("Form", "0"))
        self.consume_coal_3.setText(_translate("Form", "0"))
        self.consume_coal_4.setText(_translate("Form", "0"))
        self.groupBox_4.setTitle(_translate("Form", "统计"))
        self.label_33.setText(_translate("Form", "总发电量（GWh）"))
        self.power_all.setText(_translate("Form", "0"))
        self.label_35.setText(_translate("Form", "总煤耗（吨）"))
        self.coal_all.setText(_translate("Form", "0"))
        self.label_37.setText(_translate("Form", "年平均供电煤耗"))
        self.average_coal.setText(_translate("Form", "0"))

    def updateALL(self,state,input):
        if input=='':
            return
